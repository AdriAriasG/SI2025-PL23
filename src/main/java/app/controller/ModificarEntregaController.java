...
public class ModificarEntregaController{
    ...
    private void modificar() {
        ...
        String nuevoSubtitulo = view.getTxtSubtitulo().getText();
        String nuevoCuerpo = view.getTxtCuerpo().getText();
        ...
        // Refrescar contenido
        cargarContenidoSiExiste();
        
        // Mostrar mensaje
        JOptionPane.showMessageDialog(view.getFrame(), "Modificación realizada correctamente");
    }
}
